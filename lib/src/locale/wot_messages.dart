...
class WotMessages {
  ...
  static const Map<String, Map<String, String>> _builtin = {
    'zh_CN': {
      ...
      'wot.slideVerify.slide': '向右滑动完成验证',
      'wot.slideVerify.success': '验证通过',
      'wot.slideVerify.error': '验证失败',
      'wot.tour.skip': '跳过',
      'wot.tour.prev': '上一步',
      'wot.tour.next': '下一步',
    ...
    'en_US': {
      ...
      'wot.slideVerify.slide': 'Slide to verify',
      'wot.slideVerify.success': 'Verified',
      'wot.slideVerify.error': 'Verification failed',
      'wot.tour.skip': 'Skip',
      'wot.tour.prev': 'Previous',
      'wot.tour.next': 'Next',
